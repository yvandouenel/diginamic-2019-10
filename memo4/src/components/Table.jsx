...
class Table extends Component {
  ...
  // méthode appellée si le token a bien été récupéré
  successToken = data => {
    this.memo_fetch.token = data;
    console.log("Dans successToken");

    // J'ai mon token, je peux appeler la méthode getTerms pour récupérer les termes
    this.memo_fetch.getTerms(this.successTerms, this.failureTerms);
  };
  // Méthode appelée si j'ai bien récupéré le tableau de terms
  successTerms = data => {
    console.log("Dans successTerms", data);
    // je rajoute la propriété selected:false à la data
  ...
  // méthode appellée en cas de problème pour récupérer les termes
  failureTerms = error => {
    console.log("Dans failureTerms", error);
  };
  // méthode appellée en cas de problème pour récupérer le token
  failureToken = error => {
